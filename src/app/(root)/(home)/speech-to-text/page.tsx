...
const SpeechToText = () => {
  ...
  return (
    <div className="flex items-center justify-center ">
      <Card className="flex flex-col w-1/2 max-h-[600px] bg-slate-100 min-w-[250px]">
        <CardHeader className="flex flex-row space-y-0 justify-between items-center gap-1 p-5">
            ...
            <div className="flex max-md:flex-col justify-between gap-0">
              <Tooltip title="Download as PDF">
                <Button
                  ...
                  startIcon={
                    <BsFiletypePdf
                      className="size-[25px] max-md:size-[20px]"
                      color="black"
                    />
                  }
                  onClick={() => {
        ...
        <CardContent className="relative p-0 ">
          <div className="h-[450px]">
            ...
            <Button
              className=" left-[calc(50%-35px)] h-[10%]"
              variant="text"
              tabIndex={-1}
              startIcon={
                isListening ? (
                  <FaMicrophoneAlt size={30} color="green" />
                ) : (
                  <FaMicrophoneAltSlash size={30} color="red" />
                )
              }
